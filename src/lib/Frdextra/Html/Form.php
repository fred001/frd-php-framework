...
class Frd_Html_Form
{
   ...
   */
   ...
   {
      $default_params=array('method'=>'post');
   ...
   *multi select
   */
  function multiselect($name,$value='',$options=array(),$params=array())
  {
    $text=new Frd_Html_Form_MultiSelect($name,$value,$options,$params);
