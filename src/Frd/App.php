...
class Frd_App
{
  ...
  function controllerExists($module_name,$name)
  {
    ...
    $path=$this->module_dir."/".$name."/controller/$name.php";
  ...
  public function run($url_path=false)
  {
    ...
    if($path == false)
    {
      if($this->module_default != false && $this->module_controller_default != false)
      {
        $this->request->setData($_GET);
        $module=$this->getModule($this->module_default);

        $module->runController($this->module_controller_default);
      }
      else
      {
    ...
    //call controller
    if(!isset($params['module']) && $this->module_default !=false)
    {
      $params['module']=$this->module_default;
    }

    if(!isset($params['controller']) && $this->module_controller_default !=false)
    {
      $params['controller']=$this->module_controller_default;
    }
  ...
  public function url($path,$params=array())
  {
    ...
    return http_build_query($path,$params);
  }
